...
export const zh = {
  ...
  "card.unsaved": "未保存",
  "card.instructionPlaceholder": "这个元素要怎么修改...",
  "card.submit": "提交",
  "card.micSoon": "语音输入即将上线",
  "card.mic": "语音输入",
  "card.micListening": "正在聆听…点击停止",
  "card.micDenied": "需要麦克风权限",
  "card.micNoSpeech": "没听清，再试一次",
  "card.micNetwork": "语音服务需要联网",
  "card.micError": "语音识别出错",
...
export const en: Record<MessageKey, string> = {
  ...
  "card.mic": "Voice input",
  "card.micListening": "Listening… tap to stop",
  "card.micDenied": "Microphone permission needed",
  "card.micNoSpeech": "Didn't catch that — try again",
  "card.micNetwork": "Voice service needs a network connection",
  "card.micError": "Voice recognition error",
